...
class DefaultController extends Controller
{
    ...
    public $serviceName = 'finance.stock';
    public $formClass = StockForm::class;
    public $service = 'finance.stock';
    ...
    public function actionView($id)
    {
        ...
        $path = Yii::getAlias('@frontend/web') . '/images/stocks/';
        ...
        if ($entity->image) {
            $model->image = env('url.frontend') . 'images/stocks/'. $entity->image;
        }
